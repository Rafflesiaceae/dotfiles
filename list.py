...
sources = {
    ...
    "./.local/bin/android-remote-usb-control": "",
    ...
    "./.local/bin/cpif": "",
    "./.local/bin/cpu-monitor": "",
    "./.local/bin/cpwd": "",
    "./.local/bin/create-zip": "",
    "./.local/bin/current-weather": "",
    "./.local/bin/cycle": "",
    ...
    "./.local/bin/git-assert-initial-commit": "",
